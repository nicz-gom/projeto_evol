...
function Footer(){
    return (
        <footer style={{height: '18px', width: '100%', backgroundColor: Colors.Black, display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'absolute', bottom: 0, zIndex: 1}}>
